...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        // mu_homepage
        if ('' === $trimmedPathinfo) {
            $ret = array (  '_controller' => 'MuBundle\\Controller\\MuViewController::indexAction',  '_route' => 'mu_homepage',);
            if ('/' === substr($pathinfo, -1)) {
                // no-op
            } elseif ('GET' !== $canonicalMethod) {
                goto not_mu_homepage;
            } else {
                return array_replace($ret, $this->redirect($rawPathinfo.'/', 'mu_homepage'));
            }
        ...
        // esync_api
        if ('/api' === $pathinfo) {
            return array (  '_controller' => 'MuBundle\\Controller\\MuViewController::apiAction',  '_route' => 'esync_api',);
        }
