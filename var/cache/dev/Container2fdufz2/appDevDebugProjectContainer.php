...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'doctrine.dbal.logger.profiling.esync' => 'getDoctrine_Dbal_Logger_Profiling_EsyncService',
        ...
        $this->fileMap = [
            ...
            'doctrine.dbal.esync_connection' => 'getDoctrine_Dbal_EsyncConnectionService.php',
            ...
            'doctrine.orm.esync_entity_listener_resolver' => 'getDoctrine_Orm_EsyncEntityListenerResolverService.php',
            'doctrine.orm.esync_entity_manager' => 'getDoctrine_Orm_EsyncEntityManagerService.php',
            'doctrine.orm.esync_entity_manager.property_info_extractor' => 'getDoctrine_Orm_EsyncEntityManager_PropertyInfoExtractorService.php',
            'doctrine.orm.esync_listeners.attach_entity_listeners' => 'getDoctrine_Orm_EsyncListeners_AttachEntityListenersService.php',
            'doctrine.orm.esync_manager_configurator' => 'getDoctrine_Orm_EsyncManagerConfiguratorService.php',
            ...
            'doctrine_cache.providers.doctrine.orm.esync_metadata_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_EsyncMetadataCacheService.php',
            'doctrine_cache.providers.doctrine.orm.esync_query_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_EsyncQueryCacheService.php',
            'doctrine_cache.providers.doctrine.orm.esync_result_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_EsyncResultCacheService.php',
            ...
            'fos_user.user_listener' => 'getFosUser_UserListenerService.php',
        ...
        $this->privates = [
            ...
            'doctrine.dbal.logger.profiling.esync' => true,
            ...
            'doctrine.orm.esync_entity_listener_resolver' => true,
            'doctrine.orm.esync_entity_manager.property_info_extractor' => true,
            'doctrine.orm.esync_listeners.attach_entity_listeners' => true,
            'doctrine.orm.esync_manager_configurator' => true,
        ...
        $this->aliases = [
            ...
            'doctrine.orm.esync_metadata_cache' => 'doctrine_cache.providers.doctrine.orm.esync_metadata_cache',
            'doctrine.orm.esync_query_cache' => 'doctrine_cache.providers.doctrine.orm.esync_query_cache',
            'doctrine.orm.esync_result_cache' => 'doctrine_cache.providers.doctrine.orm.esync_result_cache',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('L+hzpp48cN', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hEijFkZFmF', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getProfilerService()
    {
        ...
        $d->addLogger('esync', ${($_ = isset($this->services['doctrine.dbal.logger.profiling.esync']) ? $this->services['doctrine.dbal.logger.profiling.esync'] : ($this->services['doctrine.dbal.logger.profiling.esync'] = new \Doctrine\DBAL\Logging\DebugStack())) && false ?: '_'});
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EkcT6nYaRY', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ifnRZg+zcS', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('16-hNFXffO', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    /**
     * Gets the private 'doctrine.dbal.logger.profiling.esync' shared service.
     *
     * @return \Doctrine\DBAL\Logging\DebugStack
     */
    protected function getDoctrine_Dbal_Logger_Profiling_EsyncService()
    {
        return $this->services['doctrine.dbal.logger.profiling.esync'] = new \Doctrine\DBAL\Logging\DebugStack();
    }
    ...
    protected function getForm_RegistryService()
    {
        return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['EasyCorp\\Bundle\\EasyAdminBundle\\Form\\Type\\EasyAdminAutocompleteType' => function () {
            ...
            return ${($_ = isset($this->services['fos_user.change_password.form.type']) ? $this->services['fos_user.change_password.form.type'] : ($this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('MuBundle\\Entity\\Utilisateur'))) && false ?: '_'};
        }, 'FOS\\UserBundle\\Form\\Type\\ProfileFormType' => function () {
            return ${($_ = isset($this->services['fos_user.profile.form.type']) ? $this->services['fos_user.profile.form.type'] : ($this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('MuBundle\\Entity\\Utilisateur'))) && false ?: '_'};
        }, 'FOS\\UserBundle\\Form\\Type\\RegistrationFormType' => function () {
            return ${($_ = isset($this->services['fos_user.registration.form.type']) ? $this->services['fos_user.registration.form.type'] : ($this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('MuBundle\\Entity\\Utilisateur'))) && false ?: '_'};
        }, 'FOS\\UserBundle\\Form\\Type\\ResettingFormType' => function () {
            return ${($_ = isset($this->services['fos_user.resetting.form.type']) ? $this->services['fos_user.resetting.form.type'] : ($this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('MuBundle\\Entity\\Utilisateur'))) && false ?: '_'};
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\doctrine\\doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'\\src\\MuBundle/Resources/views'), 'Mu');
        $instance->addPath(($this->targetDirs[3].'\\src\\MuBundle/Resources/views'), '!Mu');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'MuBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\MuBundle'),
                    'namespace' => 'MuBundle',
                ],
                'FOSUserBundle' => [
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'database_name_esync' => 'esync',
            'database_port_esync' => 3306,
            'database_user_esync' => 'eSyncExport',
            'database_password_esync' => 'eSyncPwd',
            'locale' => 'en',
            ...
            'doctrine.entity_managers' => [
                ...
                'esync' => 'doctrine.orm.esync_entity_manager',
            ],
            ...
            'doctrine.connections' => [
                ...
                'esync' => 'doctrine.dbal.esync_connection',
            ],
            ...
            'fos_user.model.user.class' => 'MuBundle\\Entity\\Utilisateur',
