...
namespace Proxies\__CG__\MuBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Utilisateur extends \MuBundle\Entity\Utilisateur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'zoneAllowed', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
    ...
    public function getZoneAllowed()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getZoneAllowed', []);

        return parent::getZoneAllowed();
    }
    ...
    public function setZoneAllowed($zoneAllowed)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setZoneAllowed', [$zoneAllowed]);

        return parent::setZoneAllowed($zoneAllowed);
    }
